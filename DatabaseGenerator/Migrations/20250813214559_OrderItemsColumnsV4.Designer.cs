...
namespace DatabaseGenerator.Migrations
{
    ...
    [Migration("20250813214559_OrderItemsColumnsV4")]
    partial class OrderItemsColumnsV4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoriaModels.Models.DriveComponents.Brake", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MoriaModels.Models.DriveComponents.Drive", b =>
                {
                    ...
                    b.Property<int?>("ExternalCoolingId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("VariatorId");

                    b.ToTable("Drives");
                });

            modelBuilder.Entity("MoriaModels.Models.DriveComponents.ExternalCooling", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ExternalCoolings");
                });

            modelBuilder.Entity("MoriaModels.Models.DriveComponents.Inverter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MoriaModels.Models.DriveComponents.Pump", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MoriaModels.Models.DriveComponents.Supplement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MoriaModels.Models.DriveComponents.Variator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MoriaModels.Models.Orders.OrderItem", b =>
                {
                    ...
                    b.Property<DateTime?>("CuttingPlanned")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("CuttingStarted")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.Property<DateTime?>("ElectricaCabinetPlanned")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("ElectricaCabinetStarted")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.Property<DateTime?>("ElectricalDiagramPlanned")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("ElectricalDiagramStarted")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.Property<DateTime?>("MachineAssembledAllCompleted")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("MachineAssembledAllStarted")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("MachineAssembledStarted")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("MachineReleased")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("MachineReleasedPlanned")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("MachineReleasedStarted")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.Property<DateTime?>("MachineWiredAndTestedStarted")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.Property<DateTime?>("MetalCliningPlanned")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("MetalCliningStarted")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.Property<DateTime?>("PaintingPlanned")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("PaintingStarted")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("PlannedMachineAssembled")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("PlannedMachineAssembledAll")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.Property<bool>("PrintedNamePlate")
                        .HasColumnType("boolean");
                    ...
                    b.Property<DateTime?>("TechnicalDrawingPlanned")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("TechnicalDrawingStarted")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.Property<DateTime?>("WeldingCompleted")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("WeldingPlanned")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("WeldingStarted")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("MoriaModels.Models.DriveComponents.Drive", b =>
                {
                    b.HasOne("MoriaModels.Models.DriveComponents.Brake", "Brake")
                        .WithMany()
                        .HasForeignKey("BrakeId");

                    b.HasOne("MoriaModels.Models.DriveComponents.ExternalCooling", "ExternalCooling")
                        .WithMany()
                        .HasForeignKey("ExternalCoolingId");

                    b.HasOne("MoriaModels.Models.DriveComponents.Inverter", "Inverter")
                        .WithMany()
                    ...
                    b.HasOne("MoriaModels.Models.DriveComponents.Pump", "Pump")
                        .WithMany()
                        .HasForeignKey("PumpId");

                    b.HasOne("MoriaModels.Models.DriveComponents.Supplement", "Supplement")
                        .WithMany()
                        .HasForeignKey("SupplementId");

                    b.HasOne("MoriaModels.Models.DriveComponents.Variator", "Variator")
                        .WithMany()
                        .HasForeignKey("VariatorId");

                    b.Navigation("Brake");

                    b.Navigation("ExternalCooling");
